...
Source: https://learn.microsoft.com/en-us/azure/foundry/guardrails/intervention-points
...
| Intervention Point | Description | Risk & Action |
|---|---|---|
...
> **Note — Performance considerations:** Guardrail processing at each intervention point adds approximately 50-100ms of latency. The actual latency varies based on content length and the number of active controls in your guardrail.
...
For detailed steps, see [Create a guardrail](https://learn.microsoft.com/en-us/azure/foundry/guardrails/how-to-create-guardrails).
...
- [Create a guardrail](https://learn.microsoft.com/en-us/azure/foundry/guardrails/how-to-create-guardrails)
